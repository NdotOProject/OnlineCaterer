        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntroduceMessage = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false, defaultValue: "Welcome"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Caterers", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatererPlace", x => new { x.CaterersUserId, x.PlacesId });
                    table.ForeignKey(
                        name: "FK_CatererPlace_Caterers_CaterersUserId",
                        column: x => x.CaterersUserId,
                        principalTable: "Caterers",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CatererPlace_Places_PlacesId",
                        column: x => x.PlacesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodTypes_Caterers_CatererId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CatererId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, defaultValue: "Thank You So Much!"),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Thank you for using our service!"),
                    ResponseDate = table.Column<DateTime>(type: "date", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResponseMessages_Caterers_CatererId",
                        column: x => x.CatererId,
                        principalTable: "Caterers",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 8, 9, 23, 49, 38, 56, DateTimeKind.Local).AddTicks(3173))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityPerUnit = table.Column<string>(type: "nvarchar(40)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "No Description"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingsDetails", x => new { x.BookingId, x.FoodId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingsDetails_Foods_FoodId",
                        column: x => x.FoodId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingsDetails_FoodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodTypes_CatererId",
                table: "FoodTypes",
                column: "CatererId");

            migrationBuilder.CreateIndex(
                name: "IX_ResponseMessages_CatererId",
