...
namespace OnlineCaterer.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(256, MinimumLength = 5, ErrorMessage = "The {0} must be at least {2} and at max {1} characters long.")]
        ...
        public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (await _userManager.FindByEmailAsync(Input.UserName) != null)
                    {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, ConstantsRoles.Customer);
